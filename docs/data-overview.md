...
|---|---:|
| 登记了多少个数据集 | 237 个 |
| 登记了多少个版本 | 324 个，其中 100 个是派生版本 |
| 支持多少类任务 | 14 类 |
| 按版本相加的可汇总时长 | 126,529.6 小时 |
| 其中：已登记时长 | 126,329.6 小时 |
| 其中：名义时长 | 200.0 小时 |
| 有可汇总时长的版本 | 55 / 324 个 |
| 完成文件完整性校验的版本 | 33 / 324 个 |
| 有内容质量记录的版本 | 2 / 324 个 |
| 已登记的逻辑数据视图 | 19 个 |
...
|---|---|---:|---:|---:|---:|
| 语音识别 | `asr` | 259 | 126,329.6 | 200.0 | 55 / 259 |
...
下面列出计入总览的 55 个版本。派生版本和不同版本可能复用同一批音频，所以这里只做版本口径统计。

<details><summary>展开 55 个版本的时长明细</summary>
...
| `realman@icefall-20260908` | 语音识别 | 83.7 | 各顶层 split 时长之和 |
